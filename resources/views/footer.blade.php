      ...
      <div class="row">
        <div class="col-md-4 mb-3 mb-md-0">
          ...
          <ul class="payments-types">
            ...
            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{config('global.THEME_PATH')}}/images/payment/paypal.png" alt="paypal" title="" data-original-title="PayPal"></a></li>
            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{config('global.THEME_PATH')}}/images/payment/american.png" alt="american express" title="" data-original-title="American Express"></a></li>
            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{config('global.THEME_PATH')}}/images/payment/mastercard.png" alt="discover" title="" data-original-title="Discover"></a></li>
          </ul>
        </div>
        <div class="col-md-4 mb-3 mb-md-0">
          <p>Subscribe</p>
...
<!--           <li class="nav-item"> <a class="nav-link active" href="#">About Us</a> </li>
 ...
 -->        </ul>
        <p class="copyright-text">Copyright © 2020 <a href="#">{{env('APP_NAME')}}</a>. All Rights Reserved.</p>
      </div>
    </div>
  </footer>
