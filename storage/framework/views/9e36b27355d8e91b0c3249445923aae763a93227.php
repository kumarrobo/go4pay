        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-4">
            <ul class="breadcrumb justify-content-start justify-content-md-end mb-0">
              ...
              <li class="active">Distributor Login</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="bg-light shadow-md rounded p-4">
        <div class="row"> 
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            ...
            <form method="POST"  id="loginForm" action="<?php echo e(route('user.verifyotp')); ?>">
             <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/go4pay/resources/views/user/otpLoginForm.blade.php ENDPATH**/ ?>