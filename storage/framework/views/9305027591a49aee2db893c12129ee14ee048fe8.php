...
<div id="main-wrapper"> 
  ...
  <div id="content"lass="bg-secondary"> 
    <section class="page-header page-header-text-light bg-secondary" style="margin-bottom: 0px">
      <div class="container">
      ...
      <div class="bg-light shadow-md rounded p-4">
        <div class="row"> 
          ...
          <div class="col-lg-4"  style=" 
              ...
              box-shadow: -5px 8px 24px -17px rgba(0,0,0,0.75); padding:15px;">
             <h2 class="text-4" style="border-bottom: solid 1px #CCC;padding-bottom: 15px;">Member Login</h2>
                 <?php if(Session::has('status')): ?>
                     <div class="card-header alert-danger"><?php echo e(__(Session::get('status'))); ?></div>
                 <?php endif; ?>     
          <div class="tab-content pt-4" style="padding:35px; ">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/go4pay/resources/views/homePage.blade.php ENDPATH**/ ?>