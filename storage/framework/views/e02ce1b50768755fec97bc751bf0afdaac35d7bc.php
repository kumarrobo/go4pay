      ...
      <div class="bg-light shadow-md rounded p-4">
        <div class="row"> 
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            ...
            <form method="POST"  id="loginForm" action="<?php echo e(route('ro.login')); ?>">
             <?php echo csrf_field(); ?>
              ...
              <div class="row mb-4">
                ...
                <div class="col-sm text-right"> 
                  ...
                  <?php if(Route::has('password.request')): ?>
                        <a class="justify-content-end" href="<?php echo e(route('ro.password.request')); ?>">
...
<?php echo $__env->make('layouts.ROdefault', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/go4pay/resources/views/RO/index.blade.php ENDPATH**/ ?>